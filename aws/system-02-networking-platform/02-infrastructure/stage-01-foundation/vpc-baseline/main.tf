...
resource "aws_subnet" "public" {
  ...
  tags = { Name = "${var.project_name}-public-${count.index + 1}", Project = var.project_name, Type = "public" }
}
resource "aws_subnet" "private" {
  ...
  availability_zone = var.availability_zones[count.index]
  tags = { Name = "${var.project_name}-private-${count.index + 1}", Project = var.project_name, Type = "private" }
}
